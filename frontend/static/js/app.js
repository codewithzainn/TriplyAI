...
(function () {
  ...
  function renderResult(result) {
    ...
    titleBox.appendChild(el("strong", null, "TriplyAI"));
    titleBox.appendChild(el("small", null, "Plan ready — M. Zain Ul Abideen"));
